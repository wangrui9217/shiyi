    ...
    <div class="content">
      <div class="item">
        ...
        <div class="item-value">
          <el-select v-model="deviceId" placeholder="选择安装产品" size="small">
            <el-option v-for="(item,index) in deviceList" :key="index" :value="item.value" :label="item.label"></el-option>
          </el-select>
        </div>
      </div>
      <!-- <div class="item" v-if="carType === 1"> -->
      <div class="item">
        <div class="item-name">安装数量:</div>
        <div class="item-value">
